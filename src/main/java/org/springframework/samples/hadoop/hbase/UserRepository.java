...
public class UserRepository {
	...
	public void delete(final String rowName) {
		hbaseTemplate.delete(tableName, rowName, "cfInfo", "user");
		hbaseTemplate.delete(tableName, rowName, "cfInfo", "email");
		hbaseTemplate.delete(tableName, rowName, "cfInfo", "password");
	}
	
	public void put(final String rowName) {
	
		hbaseTemplate.put(tableName, rowName, "cfInfo", "user", Bytes.toBytes("xx"));
		hbaseTemplate.put(tableName, rowName, "cfInfo", "email", Bytes.toBytes("xx"));
		hbaseTemplate.put(tableName, rowName, "cfInfo", "password", Bytes.toBytes("xx"));
	}
